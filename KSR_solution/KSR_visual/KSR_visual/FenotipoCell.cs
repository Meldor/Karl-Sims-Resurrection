...
namespace KSR_visual
{
    class FenotipoCell
    {
        ...
        public FenotipoCell(Vector2 bodySize, Vector2 bodyPosition, float density, World world)
        {
        ...
        public FenotipoCell(Vector2 bodySize, Vector2 bodyPosition, float density, World world, Color bodyColor, Color jointColor)
        {
        ...
        private void Initialize(Vector2 bodySize, Vector2 bodyPosition, float density, World world, Color bodyColor, Color jointColor)
        {
            ...
            ChildParts = new List<FenotipoCell>();
        }
        ...
        public void Draw(SpriteBatch spriteBatch, Texture2D rectangularTexture, Texture2D circularTexture, float zoomFactor, Color bodyColor, Color jointColor)
        {
            ...
            {
                if (CollidingSides[i])
                    Utils.DrawingHelper.DrawLine(spriteBatch, rectangularTexture, Utils.ToGraphics(vertices[i%4].Coords), Utils.ToGraphics(vertices[(i + 3)%4].Coords), Color.Red);
                else
                    Utils.DrawingHelper.DrawLine(spriteBatch, rectangularTexture, Utils.ToGraphics(vertices[i%4].Coords), Utils.ToGraphics(vertices[(i + 3)%4].Coords), Color.Green);
            }
        }
        #endregion
